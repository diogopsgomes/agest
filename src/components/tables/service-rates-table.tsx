...
export default function ServiceRatesTable() {
  ...
  const filteredServiceRates = serviceRates.filter((serviceRate) =>
    [serviceRate.name].some((field) =>
        ...
        <TableBody>
          {loading
            ...
            : filteredServiceRates.map((serviceRate, idx) => (
                <TableRow
                  key={serviceRate.service_rate_id}
                  onClick={() =>
                    router.push(
                      `/servicos/tarifas/${serviceRate.service_rate_id}`
                    )
                  }
                  className={
                    idx % 2 === 0
