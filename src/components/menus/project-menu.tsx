		...
		<div className="flex justify-between items-center gap-2 mb-8">
			<div className="flex items-center gap-2">
				...
				<AlertDialog open={showDeleteDialog}>
					<AlertDialogContent>
						<AlertDialogHeader>
							<AlertDialogTitle>De certeza que pretende eliminar o projeto?</AlertDialogTitle>
							<AlertDialogDescription>Esta ação não pode ser anulada. Isto irá eliminar permanentemente o projeto e remover os seus dados.</AlertDialogDescription>
						</AlertDialogHeader>
						<AlertDialogFooter>
