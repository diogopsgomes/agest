...
export function NewClientForm() {
  ...
  async function handleVatLookup() {
    ...
    try {
      ...
      if (data.records[vat].alias)
        form.setValue("name", data.records[vat].alias);
      if (data.records[vat].title)
        form.setValue("company", data.records[vat].title);
      if (data.records[vat].contacts.email)
        form.setValue("email", data.records[vat].contacts.email);
      if (data.records[vat].contacts.phone)
        form.setValue("tlm", data.records[vat].contacts.phone);
      if (data.records[vat].contacts.phone)
        form.setValue("tlf", data.records[vat].contacts.phone);
                  ...
                  <InputGroup>
                    ...
                    <InputGroupAddon align="inline-end">
                      <Tooltip>
                        ...
                        <TooltipContent>
                          Preencher automaticamente informações do cliente
                          através do NIPC
                        </TooltipContent>
                      </Tooltip>
                    </InputGroupAddon>
