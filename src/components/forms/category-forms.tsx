...
const FormSchema = z.object({
	name: z.string({ required_error: 'O nome da categoria é obrigatório' }).nonempty({ message: 'O nome da categoria é obrigatório' }),
});
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="lg:col-span-4">
								...
								<FormControl>
									<Input className="text-sm" placeholder="Insira o nome da categoria" {...field} />
								</FormControl>
								<FormMessage />
							</FormItem>
						)}
